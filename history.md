...
На начало ноября у приложения 61 тысяча пользователей только на ios. В приложение добавлена функция привязки номера автомобиля к транспондеру. Из важных функций отсутствует только оспаривание поездок.

## Что дальше?

Поддержите приложение и его автора! Если вы хотите, чтобы приложение развивалось и обогащалось новыми функциями, поддержите автора.
